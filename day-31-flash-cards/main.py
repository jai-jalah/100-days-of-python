...
window = Tk()
window.title("Sir, please stop flashing us")
...
unknown_button = Button(image=cross_image, bd=-2, command=next_card)
unknown_button.grid(row=1, column=0)

check_image = PhotoImage(file="images/right.gif")
known_button = Button(image=check_image, bd=-2, command=is_known)
